...
echo "insert into player_contract (player_id, time) values ('$player_id', NULL)";

$ret = mysqli_query($conn, "insert into player_contract (player_id, time) values ('$player_id', NULL)");
if(!$ret)
{
	echo mysqli_error($conn);
    msg('Query Error : '.mysqli_error($conn));
